...
export const createUsersAll = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const userIdController = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const updateAUsers = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const deleteASingleUser = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
...
export const ordersOfUsers = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
